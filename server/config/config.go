...
var Proof = struct {
	PayloadSignatureKey string `env:"TONPROOF_PAYLOAD_SIGNATURE_KEY" envDefault:"top_secret_phrase"`
	...
	ExampleDomain       string `env:"TONPROOF_EXAMPLE_DOMAIN" envDefault:"redacted.example.com"`
}{}
